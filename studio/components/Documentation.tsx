      ...
      <div className="flex-1 overflow-y-auto p-8 lg:p-16 max-w-5xl text-slate-800 leading-relaxed scroll-smooth">
        ...
        <div className="mb-12 border-b border-slate-200 pb-8">
          ...
          <p className="text-xl text-slate-500 font-light">
            A universal format for defining, sharing, and executing multi-agent
            AI workflows.
            <br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-slate-600 mb-4 text-sm leading-6">
                AI agents are currently fragmented across proprietary platforms.
                There is no unified standard for defining how multiple agents
                interact, maintain context, or execute tools across different
                execution environments (runtimes). This leads to vendor lock-in
                and limits interoperability.
              </p>
            </div>
            <div>
              <h3 className="font-bold text-slate-800 mb-2">Value Proposition</h3>
              <p className="text-slate-600 mb-4 text-sm leading-6">
                AIFLOW provides a portable, self-contained JSON-based
                specification. It decouples the <strong>logic</strong> of the
                workflow from the <strong>execution engine</strong>, enabling
                agents to run on local devices, cloud clusters, or hybrid
        ...
        <section id="architecture" className="mb-16 scroll-mt-8">
          ...
          <p className="text-slate-600 mb-6">
            An <code>.aiflow</code> file is technically a ZIP container. This
            ensures that a single file contains all necessary assets (prompts,
            schemas, code snippets) to run the workflow offline or online.
          </p>
          <div className="bg-slate-900 text-slate-300 p-6 rounded-xl font-mono text-sm shadow-lg overflow-hidden relative">
            <div className="absolute top-0 right-0 p-2 text-xs text-slate-500">
              Container Structure
            </div>
            <div className="flex flex-col space-y-1">
              <span className="text-indigo-400">root.aiflow</span>
              <span className="pl-4">
                ├── <span className="text-white font-bold">flow.json</span>{' '}
                <span className="text-slate-500">
                  // Entry point &amp; Logic graph
                </span>
              </span>
              <span className="pl-4">
              ...
              <span className="pl-4">
                ├── <span className="text-amber-400">prompts/</span>
              </span>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-sm text-slate-600 mb-3">
                Defines the high-level orchestration.
              </p>
      ...
      "condition": "output.classification == 'technical'"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white p-5 rounded-lg border border-slate-200 shadow-sm">
              ...
              <ul className="text-xs text-slate-600 space-y-2 list-disc pl-4">
                <li>
                  <strong>Minimize Context:</strong> Pass only essential
                  variables between agents (<code>output_format: json</code>) to
                  reduce token costs and latency.
                </li>
                <li>
                  <strong>Parallelize:</strong> Use branching logic in{' '}
                  <code>flow.json</code> to run independent agents (e.g.,
                  research and drafting) simultaneously.
                </li>
                <li>
                  <strong>Cache Tools:</strong> Enable caching for deterministic
                  tool outputs (like web search for the same query).
                </li>
              </ul>
            </div>
            <div className="bg-white p-5 rounded-lg border border-slate-200 shadow-sm">
              ...
              <ul className="text-xs text-slate-600 space-y-2 list-disc pl-4">
                <li>
                  <strong>Trace IDs:</strong> Ensure the runtime assigns a
                  unique <code>trace_id</code> to every flow execution to track
                  it across logs.
                </li>
                <li>
                  <strong>Intermediate States:</strong> Use a &quot;Debug
                  Mode&quot; runtime that saves the output of every agent to a{' '}
                  <code>debug/</code> folder.
                </li>
                <li>
                  <strong>Mocking:</strong> Replace expensive LLM calls with
                  static responses in <code>agents/*.json</code> during logic
                  testing.
                </li>
              </ul>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div className="border border-slate-200 p-4 rounded-lg">
              ...
              <p className="text-slate-500 text-xs">
                An entry agent classifies user input and routes it to
                specialized sub-agents. Used in Customer Support.
              </p>
            </div>
            <div className="border border-slate-200 p-4 rounded-lg">
              <strong className="block text-indigo-700 mb-2">
              ...
              <p className="text-slate-500 text-xs">
                Linear execution where Agent A&apos;s output is Agent B&apos;s
                input. Used in Content Generation (Plan → Write → Edit).
              </p>
            </div>
            <div className="border border-slate-200 p-4 rounded-lg">
              <strong className="block text-indigo-700 mb-2">
              ...
              <p className="text-slate-500 text-xs">
                A manager agent breaks down a complex goal into tasks and
                delegates them to worker agents, aggregating results.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="example" className="mb-16 scroll-mt-8">
          ...
          <p className="text-sm text-slate-600 mb-6">
            This reference implementation demonstrates a multi-agent helpdesk
            system using the <strong>Triage Pattern</strong>.
          </p>
            ...
            <div className="lg:w-1/3">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-4 font-mono text-xs text-slate-600">
                <div className="flex items-center text-indigo-600 font-bold mb-2">
                  <Folder size={14} className="mr-2" /> customer_support/
                </div>
                ...
                <div className="pl-8 flex items-center mb-1">
                  ├── tech_solver.json
                </div>
                <div className="pl-8 flex items-center mb-1">
                  └── responder.json
            ...
            <div className="lg:w-2/3 space-y-4">
              <div className="bg-white border border-slate-200 rounded-lg p-4">
                ...
                <ul className="list-disc pl-5 text-xs text-slate-600 space-y-1">
                  <li>
                    <strong>TriageBot (Classifier):</strong> Analyzes ticket
                    sentiment and category. Routing logic depends on its output.
                  </li>
                  <li>
                    <strong>TechSolver (Engineer):</strong> Has access to{' '}
                    <code>web_search</code> and <code>stack_overflow</code>{' '}
                    tools to find technical fixes.
                  </li>
                  <li>
                    <strong>Responder (Copywriter):</strong> Takes the raw
                    solution and formats it into a polite email.
                  </li>
                </ul>
              </div>
              <div className="bg-white border border-slate-200 rounded-lg p-4">
...
console.log(result.final_output);`}
            ...
            <div>
              ...
              <ul className="bg-slate-50 border border-slate-200 rounded-lg p-4 text-xs text-slate-700 space-y-2 list-disc pl-5">
                <li>
                  <strong>Schema Check:</strong> Validate{' '}
                  <code>flow.json</code> against the AIFLOW JSON Schema v1.0.
                </li>
                <li>
                  <strong>Graph Integrity:</strong> Ensure no circular
                  dependencies exist (unless explicitly allowed via{' '}
                  <code>max_loops</code>).
                </li>
                <li>
                  <strong>Tool Availability:</strong> Verify that all tools
                  referenced in <code>agents/*.json</code> exist in{' '}
                  <code>tools/registry.json</code>.
                </li>
                <li>
                  <strong>Asset Links:</strong> Check that prompt file paths
                  (e.g., <code>../prompts/file.txt</code>) resolve correctly.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start bg-white border border-slate-200 p-4 rounded-lg shadow-sm">
              ...
              <div>
                ...
                <p className="text-xs text-slate-600 mt-1">
                  Standardization for <code>ui_schema.json</code>. This allows
                  agents to request user input via rich UI components (forms,
                  date pickers, maps) instead of just raw text.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start bg-white border border-slate-200 p-4 rounded-lg shadow-sm">
              ...
              <div>
                ...
                <p className="text-xs text-slate-600 mt-1">
                  Support for <code>.aiplugin</code> bundles to distribute
                  tools. Introduction of standardized <strong>Event Hooks</strong>{' '}
                  (e.g., <code>onTokenStream</code>, <code>onToolStart</code>)
                  for real-time frontend observability via WebSockets.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start bg-white border border-slate-200 p-4 rounded-lg shadow-sm">
              ...
              <div>
                ...
                <p className="text-xs text-slate-600 mt-1">
                  Native support for audio and video streams as first-class
                  citizens passed between agents, enabling real-time
                  voice-to-voice workflows without external transcoding steps.
                </p>
              </div>
            </div>
          </div>
